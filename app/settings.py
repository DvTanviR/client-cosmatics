...
SECRET_KEY = 'django-insecure-^t-1e7!l$h^1xnz#ltz!j6j_v2uhst@dn86d&b%%yy9v+m=%f)'
...
# Allow larger uploads (base64-encoded wishlist payloads can be big). Set to 50MB.
